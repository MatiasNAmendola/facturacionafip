...
abstract class BaseClientePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'RazonSocial', 'Cuit', 'Activo', 'Direccion', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'razonSocial', 'cuit', 'activo', 'direccion', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::RAZON_SOCIAL, self::CUIT, self::ACTIVO, self::DIRECCION, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'razon_social', 'cuit', 'activo', 'direccion', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'RazonSocial' => 1, 'Cuit' => 2, 'Activo' => 3, 'Direccion' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'razonSocial' => 1, 'cuit' => 2, 'activo' => 3, 'direccion' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::RAZON_SOCIAL => 1, self::CUIT => 2, self::ACTIVO => 3, self::DIRECCION => 4, self::CREATED_AT => 5, self::UPDATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'razon_social' => 1, 'cuit' => 2, 'activo' => 3, 'direccion' => 4, 'created_at' => 5, 'updated_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ClientePeer::CUIT);
