...
//  }
  ...
  private function generarComprobante(ComprobanteForm $form){
  	 ...
  	 * @var unknown_type
  	 */
  	$ultimoNro = WsfeClient::UltNro($client, $token, $sign, WsfeClient::getCuitEmisor());
  	/**
  	 * TODO: Realizar las validaciones pertinentes de las posibles salidas
  	 * @var unknown_type
  	 */
  	$comprobante = WsfeClient::Aut($client, $token, $sign, WsfeClient::getCuitEmisor(), $ultimoNro + 1, $ultimoNro + 1, $comprobante);
