...
abstract class BaseTipoDocumentoPeer {
	...
	const CODE = 'tipo_documento.CODE';

	/** the column name for the DESCRIPTION field */
	const DESCRIPTION = 'tipo_documento.DESCRIPTION';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(TipoDocumentoPeer::CODE);

		$criteria->addSelectColumn(TipoDocumentoPeer::DESCRIPTION);
