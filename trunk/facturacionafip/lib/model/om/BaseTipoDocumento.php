...
abstract class BaseTipoDocumento extends BaseObject  implements Persistent {
  ...
  const PEER = 'TipoDocumentoPeer';
	...
	public function setCode($v)
	{
		...
		if ($this->code !== $v) {
			$this->code = $v;
			$this->modifiedColumns[] = TipoDocumentoPeer::CODE;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = TipoDocumentoPeer::DESCRIPTION;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TipoDocumentoPeer::CODE)) $criteria->add(TipoDocumentoPeer::CODE, $this->code);
		if ($this->isColumnModified(TipoDocumentoPeer::DESCRIPTION)) $criteria->add(TipoDocumentoPeer::DESCRIPTION, $this->description);
	 ...
	 * related Clientes from storage. If this TipoDocumento is new, it will return
		...
		if ($this->collClientes === null) {
			if ($this->isNew()) {
			   $this->collClientes = array();
				...
				$criteria->add(ClientePeer::TIPO_DOCUMENTO_ID, $this->id);
