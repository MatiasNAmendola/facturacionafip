...
abstract class BaseCliente extends BaseObject  implements Persistent {
  ...
  const PEER = 'ClientePeer';
	...
	public function setCuit($v)
	{
		...
		if ($this->cuit !== $v) {
			$this->cuit = $v;
			$this->modifiedColumns[] = ClientePeer::CUIT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = ClientePeer::NUM_COLUMNS - ClientePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ClientePeer::CUIT)) $criteria->add(ClientePeer::CUIT, $this->cuit);
